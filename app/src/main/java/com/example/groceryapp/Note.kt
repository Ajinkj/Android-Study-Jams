...
class Note (@ColumnInfo(name = "title")val noteTitle :String,@ColumnInfo(name = "Quantity")val Quantity :String,@ColumnInfo(name = "description")val noteDescription :String,@ColumnInfo(name = "timestamp")val timeStamp :String) {
